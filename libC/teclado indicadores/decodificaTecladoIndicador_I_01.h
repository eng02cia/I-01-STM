...
//linhas imput   
    ...
    TRISDbits.TRISD6 = 1;//tecla comando liga/desliga
    TRISDbits.TRISD7 = 1;//tecla comando zero
    TRISBbits.TRISB6 = 1;//tecla comando tara
    TRISBbits.TRISB7 = 1;//tecla comando print
