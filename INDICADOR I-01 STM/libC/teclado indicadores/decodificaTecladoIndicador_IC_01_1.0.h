...
// controle do zero do indicador
    if(controleTara == _TARADESATIVADA && statusLigaDesliga == _LIGADO)
    {
        if(indicadorEmZero == 1){HAL_GPIO_WritePin(LED5_GPIO_Port , LED5_Pin,GPIO_PIN_SET);}
        else{HAL_GPIO_WritePin(LED5_GPIO_Port , LED5_Pin,GPIO_PIN_RESET);}
    }else{HAL_GPIO_WritePin(LED5_GPIO_Port , LED5_Pin,GPIO_PIN_RESET);}
//controle da tara
    if(controleTara == _TARAATIVADA && statusLigaDesliga == _LIGADO){HAL_GPIO_WritePin(LED6_GPIO_Port,LED6_Pin,GPIO_PIN_SET);}
